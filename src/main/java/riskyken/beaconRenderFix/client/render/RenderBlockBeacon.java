package riskyken.beaconRenderFix.client.render;
...
public class RenderBlockBeacon extends TileEntitySpecialRenderer {
    ...
    public RenderBlockBeacon() {
        startTick = System.currentTimeMillis();
    }
    
    @Override
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float p_147500_8_) {
        renderTileEntityAt((TileEntityBeacon)tileEntity, x, y, z, p_147500_8_);
    }
    
    public void renderTileEntityAt(TileEntityBeacon tileEntity, double x, double y, double z, float p_147500_8_) {
